...
public class tendinousVO {
	...
	public String getTendinous_img() {
		return tendinous_img;
	}
	public void setTendinous_img(String tendinous_img) {
		this.tendinous_img = tendinous_img;
	}
	...
	public String toString() {
		return "tendinousVO [tno=" + tno + ", tendinous_title=" + tendinous_title + ", tendinous_cont=" + tendinous_cont
				+ ", tendinous_cnt=" + tendinous_cnt + ", tendinous_img=" + tendinous_img + ", tendinous_data="
				+ tendinous_data + ", id=" + id + ", type=" + type + "]";
	} // 페이지 분류를 위한 컬럼
