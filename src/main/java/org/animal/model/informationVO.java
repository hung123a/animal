...
public class informationVO {
	...
	public String toString() {
		return "informationVO [ino=" + ino + ", main_img=" + main_img + ", animal_name=" + animal_name + ", habitat="
				+ habitat + ", look=" + look + ", life=" + life + ", food=" + food + ", enemy=" + enemy
				+ ", animal_data=" + animal_data + ", i_type=" + i_type + ", id=" + id + ", animal_date=" + animal_date
				+ ", info=" + info + ", type=" + type + ", bgno=" + bgno + "]";
	}
